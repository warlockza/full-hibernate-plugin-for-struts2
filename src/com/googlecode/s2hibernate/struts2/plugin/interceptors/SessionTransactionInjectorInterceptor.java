...
//						System.out.println(campo.getName()+" "+campo.getDeclaringClass());
	...
	private void detectAndCloseHibernateCoreSessionCreatedLater(Object targetObject) throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, ClassNotFoundException {
		Class testClass = targetObject.getClass();
		while (isCandidadeClass(testClass)) {
			Field[] campos = testClass.getDeclaredFields();
	...
	private void detectAndCommitHibernateTransactionCreatedLater(Object targetObject) throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, ClassNotFoundException {
		Class testClass = targetObject.getClass();
		while (isCandidadeClass(testClass)) {
			Field[] campos = testClass.getDeclaredFields();
	...
	private void detectAndRollbackHibernateTransactionCreatedLater(Object targetObject) throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, ClassNotFoundException {
		Class testClass = targetObject.getClass();
		while (isCandidadeClass(testClass)) {
			Field[] campos = testClass.getDeclaredFields();
